              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form method="POST" action="php/updatepreferences.php">
                    <div class="form-row">
                    <div class="col">
                    ...
                    <div class="col">
                     ...
                     <div class="form-row">
                    <div class="col">
                    <button type="submit" class="btn btn-primary" id="add-preferences" name="add-preferences">Add Preferences</button>
                    </div>
                    <div class="col">
                    <button type="submit" class="btn btn-primary" id="update-references" name="update-references">Update Preferences</button>
                    </div>
                     </div>
