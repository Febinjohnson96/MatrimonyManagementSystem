...
<!DOCTYPE html>
<html lang="en">
<!-- Copied from http://admin.pixelstrap.com/endless/ltr/index.html by Cyotek WebCopy 1.8.0.652, Friday, April 24, 2020, 6:53:54 AM -->
  <head>
            ...
            <ul class="sidebar-menu">
              <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Dashboard</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  <li><a href="index.php"><i class="fa fa-circle"></i><span>Default</span></a></li>
              ...
              <div class="col-xl-8 xl-100">
                <div class="row">
                      ...
                      <div class="card-body">
                        <div class="chart-widget-dashboard">
                          <div class="media">
                            <div class="media-body">
                              <?php 
                              $sql_usercount="SELECT (SELECT COUNT(*) FROM `users`) as userCount";
                              // $sql_usercount="SELECT COUNT() FROM `users`";
                              $result = mysqli_query($conn, $sql_usercount); 
                              $row = mysqli_fetch_array($result);
                              ?>
                              <h5 class="mt-0 mb-0 f-w-600"><?php echo $row['userCount']; ?></h5>
                              <p>Total Users</p>
                      ...
                      <div class="card-body">
                        <div class="chart-widget-dashboard">
                          <div class="media">
                            <div class="media-body">
                              <?php 
                                 $sql_invoicecount="SELECT (SELECT COUNT(*) FROM `invoice`) as invoiceCount";
                                 // $sql_usercount="SELECT COUNT() FROM `users`";
                                 $result = mysqli_query($conn, $sql_invoicecount); 
                                 $row = mysqli_fetch_array($result);
                              ?>
                              <h5 class="mt-0 mb-0 f-w-600"><?php echo $row['invoiceCount']; ?></h5>
                      ...
                      <div class="card-body">
                        <div class="chart-widget-dashboard">
                          <div class="media">
                            <div class="media-body">
                              <?php 
                              $sql_pckcount="SELECT (SELECT COUNT(*) FROM `package`) as pckCount";
                              // $sql_usercount="SELECT COUNT() FROM `users`";
                              $result = mysqli_query($conn, $sql_pckcount); 
                              $row = mysqli_fetch_array($result);
                              ?>
                              <h5 class="mt-0 mb-0 f-w-600"><?php echo $row['pckCount']; ?></h5>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                    <?php 
                    $sql = "SELECT * FROM `users` NATURAL JOIN `userpicture` WHERE roleID !=1";  
                    ...
                    ?>
                      <tr>
                        ...
                        <td><img class="img-70 rounded-circle" alt="" src="pic/<?php echo $row['propic']?>"></td>
                      </tr>
              ...
              <div class="col-xl-5 xl-100">
                <div class="card">
                  <div class="card-header card-header-border">
                    <div class="row">
                      <div class="col-sm-6">
                        <h5 class="align-abjust">Selling Update</h5>
                      </div>
                      <div class="col-sm-6">
                        <div class="pull-right right-header">
                          <div class="onhover-dropdown">
