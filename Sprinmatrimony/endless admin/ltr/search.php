...
<!DOCTYPE html>
<html lang="en">
<!-- Copied from http://admin.pixelstrap.com/endless/ltr/search.html by Cyotek WebCopy 1.8.0.652, Friday, April 24, 2020, 6:53:54 AM -->
          ...
          <ul class="sidebar-menu">
            <li><a class="sidebar-header" href="#"><i data-feather="home"></i><span>Dashboard</span><span class="badge badge-pill badge-primary">6</span><i class="fa fa-angle-right pull-right"></i></a>
              <ul class="sidebar-submenu">
                <li><a href="user-profile.php"><i class="fa fa-circle"></i><span>Default</span></a></li>
            ...
            <li><a class="sidebar-header" href="#"><i data-feather="message-square"></i><span>Chat</span><i class="fa fa-angle-right pull-right"></i></a>
              <ul class="sidebar-submenu">
                <li><a href="chat.html"><i class="fa fa-circle"></i>Messages</a></li>
            ...
            <li><a class="sidebar-header" href="#"><i data-feather="shopping-bag"></i><span>Payment</span><i class="fa fa-angle-right pull-right"></i></a>
              <ul class="sidebar-submenu">
                <li><a href="payment-details.html"><i class="fa fa-circle"></i>Payment</a></li>
                <!-- <li><a href="chat-video.html"><i class="fa fa-circle"></i>Video chat</a></li> -->
              </ul>
            </li>
            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header">
                  <!-- <form class="search-form" action="php/searchuser.php" method="POST">
                    <div class="form-group m-0">
                      <label class="sr-only">Email</label>
                      <input class="form-control" type="search" name="term" placeholder="Search user by name">
                    </div>
                  </form> -->
                </div>
                <div class="card-body">
                  <!-- <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                      <li class="nav-item"><a class="nav-link active" id="all-link" data-toggle="tab" href="#all-links" role="tab" aria-selected="true"><i class="icon-target"></i>All</a>
                        <div class="material-border"></div>
                      </li>
                      <li class="nav-item"><a class="nav-link" id="image-link" data-toggle="tab" href="#image-links" role="tab" aria-selected="false"><i class="icon-image"></i>Images</a>
                        <div class="material-border"></div>
                      </li>
                      <li class="nav-item"><a class="nav-link" id="video-link" data-toggle="tab" href="#video-links" role="tab" aria-selected="false"><i class="icon-video-clapper"></i>Videos</a>
                        <div class="material-border"></div>
                      </li>
                      <li class="nav-item"><a class="nav-link" id="map-link" data-toggle="tab" href="#map-links" role="tab" aria-selected="false"><i class="icon-map-alt"></i>Maps</a>
                        <div class="material-border"></div>
                      </li>
                      <li class="nav-item"><a class="nav-link" id="setting-link" data-toggle="tab" href="#setting-links" role="tab" aria-selected="false"><i class="icon-settings"></i>Settings</a>
                        <div class="material-border"></div>
                      </li>
                    </ul> -->
                      ...
                      <div class="row">
                        <div class="col-xl-12">
                          <!-- <div class="card">
                            <div class="card-header">
                              <h5 class="mb-0">
                                <button class="btn btn-primary text-center" data-toggle="collapse" data-target="#collapseicon" aria-expanded="true" aria-controls="collapseicon">Filter</button>
                              </h5>
                            </div>
                            <div class="collapse show" id="collapseicon" aria-labelledby="collapseicon" data-parent="#accordion">
                              <div class="card-body filter-cards-view animate-chk">
                                <div class="job-filter">
                                  <div class="faq-form">
                                    <input class="form-control" type="text" placeholder="Profession"><i class="search-icon" data-feather="briefcase"></i>
                                  </div>
                                </div>
                                <div class="job-filter">
                                  <div class="faq-form">
                                    <input class="form-control" type="text" placeholder="District"><i class="search-icon" data-feather="map-pin"></i>
                                  </div>
                                </div>
                              ...
                              <label class="d-block" for="chk-ani5">
                                ...
                                <button class="btn btn-primary text-center" type="button">Update Filters</button>
                              </div>
                            </div>
                          </div> -->
                        </div>
                        <div class="col-md-12">
                          <div class="table-responsive">
                            <table class="table table-border table-striped custom-table mb-0">
                              ...
                              <tbody>
                                <?php
                                  $sql_pref = "SELECT * FROM `matchingcredentials` WHERE userID = '$tempId'";  
                                  $result = mysqli_query($conn, $sql_pref); 
                                  $row = mysqli_fetch_array($result);
                                  $age1=$row['age'];
                                  ...
                                  $gender=$row['gender'];
                                  if($gender == "male"){ $maxage = $age1+10; $minage = $age1;}
                                  else { $minage = $age1-10; $maxage = $age1; }
                                  // echo $age1. "\n" .$profession. "\n" .$education. "\n" .$district. "\n" .$gender;
                                  // echo "<script type='text/javascript'>alert('$district');</script>";
                                  // echo "min" . $minage;
                                  // echo "max" . $maxage;

                                $sql_search = "SELECT * FROM `user_public` WHERE userID != '$tempId' AND gender='$gender'  AND district ='$district' ";
                                $result = mysqli_query($conn, $sql_search);
                                while ($row = mysqli_fetch_array($result)) {
                                  $tempids = $row['userID'];
                                  //if(($row['age'] <= '$maxage') && ($row['age'] >= '$minage')){
                                     if(($row['age'] >= '$minage') ){
                                      // echo "Success";
                                ?>
                                <tr>
                                  ...
                                  <td><a class="btn btn-primary" href ="user-profile_public.php?usersid=<?=$row['userID'];?>">View Profile</a></td>
                                </tr>
                              <?php } } ?>
                              </tbody>
                            </table>
                        ...
                        <div class="row">
                          <div class="col-xl-6">
                            ...
                            <div class="media info-block">
                              <iframe class="mr-3 mb-3" width="200" height="100" src="../../embed/CJnfAXlBRTE.html"></iframe>
                              <div class="media-body">
                            ...
                            <div class="media info-block">
                              <iframe class="mr-3 mb-3" width="200" height="100" src="../../embed/-L4gEk7cOfk.html"></iframe>
                              <div class="media-body">
                            ...
                            <div class="media info-block">
                              <iframe class="mr-3 mb-3" width="200" height="100" src="../../embed/FZzWGr3ruVw.html"></iframe>
                              <div class="media-body">
                            ...
                            <div class="media info-block">
                              <iframe class="mr-3 mb-3" width="200" height="100" src="../../embed/wpmHZspl4EM.html"></iframe>
                              <div class="media-body">
                          ...
                          <div class="col-xl-6">
                            <div>
                              <div class="embed-responsive embed-responsive-21by9 lg-mt">
                                <iframe width="560" height="315" src="../../embed/wpmHZspl4EM.html" allowfullscreen=""></iframe>
                              </div>
                              <div class="embed-responsive embed-responsive-21by9">
                                <iframe width="560" height="315" src="../../embed/I0-vBdh4sZ8.html" allowfullscreen=""></iframe>
                              </div>
                            </div>
                          </div>
                        </div>
