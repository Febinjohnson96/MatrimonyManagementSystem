...
include('php/connection.php');
 ...
 $tempId=$_SESSION['id'];
 $useid=$_GET['usersid'];
 $sql = "SELECT * FROM `user_public` NATURAL JOIN `userpicture`  WHERE  userID = '$useid' AND userID='$tempId'"; 
 					$result = mysqli_query($conn, $sql); 
          $row = mysqli_fetch_array($result);
          
          // $sql_sess = "SELECT * FROM `users` NATURAL JOIN `userpicture`  WHERE  userID = '$tempId'"; 
 					// $result = mysqli_query($conn, $sql_sess); 
          // $row = mysqli_fetch_array($result);
?>
<!DOCTYPE html>
<html lang="en">
<!-- Copied from http://admin.pixelstrap.com/endless/ltr/chat.html by Cyotek WebCopy 1.8.0.652, Friday, April 24, 2020, 6:53:54 AM -->
  <head>
    ...
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="../assets/flagicont.css">
    <!-- Feather icon-->
                  ...
                  <div class="card-body p-0">
                    <div class="row chat-box">
                      ...
                      <div class="col pr-0 chat-right-aside">
                        ...
                        <div class="chat">
                          <!-- chat-header start-->
                          <div class="chat-header clearfix"><img class="rounded-circle" src="pic/<?php echo $row['propic']?>" alt="">
                            <div class="about">
                              <div class="name"><?php echo $row ['firstName']; ?>  <span class="font-primary f-12"></span></div>
                              ...
                              <div class="col-xl-12 d-flex">
                                ...
                                <div class="input-group text-box">
                                  ...
                                  <div class="input-group-append">
                                    <button class="btn btn-primary" type="button" onclick="updatemessage()">SEND</button>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <!-- <div class="col pl-0 chat-menu">
                        <ul class="nav nav-tabs border-tab nav-primary" id="info-tab" role="tablist">
                          <li class="nav-item"><a class="nav-link active" id="info-home-tab" data-toggle="tab" href="#info-home" role="tab" aria-selected="true">CALL</a>
                            <div class="material-border"></div>
                          </li>
                          <li class="nav-item"><a class="nav-link" id="profile-info-tab" data-toggle="tab" href="#info-profile" role="tab" aria-selected="false">STATUS</a>
                            <div class="material-border"></div>
                          </li>
                          <li class="nav-item"><a class="nav-link" id="contact-info-tab" data-toggle="tab" href="#info-contact" role="tab" aria-selected="false">PROFILE</a>
                            <div class="material-border"></div>
                          </li>
                        </ul>
