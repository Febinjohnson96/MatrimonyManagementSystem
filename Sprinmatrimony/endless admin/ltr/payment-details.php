...
session_start();
$tempId=$_SESSION['id'];
$sql = "SELECT * FROM `invoicedetails`  WHERE  userID = '$tempId'";  
          ...
          <div class="container-fluid credit-card">
            <div class="row">
                ...
                <div class="card height-equal">
                  ...
                  <div class="card-body">
                    <form class="theme-form e-commerce-form row" method="POST" action="php/paymentupdate.php">
                      ...
                      <div class="col-12">
                        <button class="btn btn-primary-gradien btn-block" id="pay" name="pay" type="submit">Submit</button>
                      </div>
                    </form>
                  </div>
                </div>
              ...
              <!-- EMI Starts-->
               ...
               <table class="table cell-border" id="example-style-3">
                        <thead>
                          <tr>
                          <!-- background-color:#D6DBDF;" -->
                            ...
                            <th style="padding: 10px;">Package Amount</th>
                            <th style="padding: 10px;">Package Validity</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            ...
                            <td><?php echo $row['PckName']; ?></td>
                            <td><?php echo $row['InvoiceDate']; ?></td>
                            <td><?php echo $row['PckAmt']; ?></td>
                            <td><?php echo $row['PckValidity']; ?> Days</td>
                          </tr>
