...
//from userpic
          // $sql_userpic = "SELECT * FROM `userpicture` WHERE userID = '$tempId'";  
 					// $result = mysqli_query($conn, $sql_userpic); 
					// $row = mysqli_fetch_array($result);
?>
<!DOCTYPE html>
<html lang="en">
<!-- Copied from http://admin.pixelstrap.com/endless/ltr/edit-profile.html by Cyotek WebCopy 1.8.0.652, Friday, April 24, 2020, 6:53:54 AM -->
  <head>
      ...
      <div class="page-body-wrapper">
        ...
        <div class="page-sidebar">
          <div class="main-header-left d-none d-lg-block">
            <div class="logo-wrapper"><a href="user-profile.php"><img src="../assets/images/endless-logo.png" alt=""></a></div>
          </div>
            ...
            <ul class="sidebar-menu">
              ...
              <li><a class="sidebar-header" href="#"><i data-feather="shopping-bag"></i><span>Payment</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                  ...
                  <li><a href="payment-details.php"><i class="fa fa-circle"></i>Payment Details</a></li>
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form method="POST" action="php/propic.php" enctype="multipart/form-data">
                        <div class="row mb-2">
                          <div class="col-auto"><img class="img-70 rounded-circle" alt="" src="pic/<?php echo $row['propic']?>"></div>
                          <div class="col">
                            <h3 class="mb-1"><?php echo $row ['firstName']; ?> <?php echo $row ['lastName']; ?></h3>
                            <p class="mb-4"><?php echo $row ['profession']; ?></p>
                          </div>
                        </div>
                        <div class="form-group">
                          <h6 class="form-label">Update Profile Picture</h6>
                           <div class="custom-file">
                              <input type="file" class="custom-file-input" id="picupload" name="picupload">
                        ...
                        <div class="form-footer">
                          <button class="btn btn-primary btn-block" id="submit" name="submit" >Save</button>
                        </div>
                        <div class="form-footer mt-2">
                          <button class="btn btn-primary btn-block" id="update" name="update" >Update</button>
                        </div>
                      </form>
                    </div>
                    <div class="card-body">
                      <form method="POST" action="php/updatepassword.php">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" type="password" id="passupdate" name="passupdate" placeholder="password">
                        </div>
                        <!-- <div class="form-group">
                          <label class="form-label">Password</label>
                          <input class="form-control" type="password" value="password">
                        ...
                        <div class="form-footer">
                          <button class="btn btn-primary btn-block" id="updatepass" name="updatepass" >Update Password</button>
                        </div>
                        <!-- <div class="form-footer mt-2">
                          <button class="btn btn-primary btn-block" id="update" name="update" >Update</button>
                        </div> -->
                ...
                <div class="col-lg-8">
                <form class="card" method="POST" action="php/updateprofile.php">
                    <div class="card-header">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="number" id="age" name="age" value="<?php echo $row ['age']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="profession" name="profession" value="<?php echo $row ['profession']; ?>">
                          </div>
                        </div>
                        <div class="col-sm-6 col-md-4">
                          <div class="form-group">
                            <label class="form-label">Distrcit</label>
                            <input class="form-control" type="text" id="district" name="district" value="<?php echo $row ['district']; ?>">
                          </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                          <div class="form-group">
                            <label class="form-label">Locality</label>
                            <input class="form-control" type="text" name="locality" name="locality" value="<?php echo $row ['locality']; ?>">
                          </div>
                        </div>
                        <div class="col-md-5">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="number" id="pin" name="pin" value="<?php echo $row ['pin']; ?>">
                            </div>
                        </div>
                        <!-- <div class="col-md-12">
                    ...
                    <div class="card-footer text-right">
                      <button class="btn btn-primary" type="submit" id="updateprofile" name="updateprofile">Update Profile</button>
                    </div>
                  </form>
                </div>
                <!-- <div class="col-md-12">
