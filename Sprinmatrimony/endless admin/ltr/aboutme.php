...
<!DOCTYPE html>
<html lang="en">
<!-- Copied from http://admin.pixelstrap.com/endless/ltr/list-wish.html by Cyotek WebCopy 1.8.0.652, Friday, April 24, 2020, 6:53:54 AM -->
                ...
                <div class="container-fluid">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><i data-feather="x-circle"></i></td>
                                    ...
                                    <form method="POST" action="php/aboutuser.php">
                                        <div class="form-row">
                                            <div class="col">
                                                <textarea id="aboutme" name="aboutme" rows="4" cols="50"></textarea>
                                            </div>
                                            <div class="col">
                                                <textarea id="aboutyou" name="aboutyou" rows="4" cols="50"></textarea>
                                            </div>
                                        </div>
                                        <!--<div class="col">
                    ...
                    <div class="col">
                     ...
                     <br>
                                        <div class="form-row">
                                            <div class="col">
                                                <button type="submit" class="btn btn-primary" id="add-about" name="add-about">Add Details</button>
                                            </div>
                                            <div class="col">
                                                <button type="submit" class="btn btn-primary" id="update-about" name="update-about">Update Details</button>
                                            </div>
                                        </div>
                                        <!-- <button type="submit" class="btn btn-primary" id="Preferences" name="Preferences">Add Preferences</button> -->
                                    </form>
                                </div>
                            </div>
                        </div>
