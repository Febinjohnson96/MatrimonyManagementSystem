...
$tempId = $_SESSION['id'];
$useid = $_GET['usersid'];
$sql = "SELECT * FROM `user_public` NATURAL JOIN `userpicture`  WHERE  userID = '$useid'";
              ...
              <div class="col-sm-12">
                <div class="card hovercard text-center">
                  ...
                  <div class="info">
                    <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="ttl-info text-left">
                              ...
                              <a class="btn btn-primary" href="chat.php?usersid=<?= $useid; ?>"><span style="color: #ffffff">Message</span></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-12 col-lg-4 order-sm-0 order-xl-1">
                        <div class="user-designation">
                          <div class="title"><?php echo $row['firstName']; ?> </div>
                          <div class="desc mt-2"><?php echo $row['profession']; ?> </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="ttl-info text-left">
                              ...
                              <a class="btn btn-primary"><span style="color: #ffffff">Like Profile</span></a>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="ttl-info text-left">
                    ...
                    <div class="container-fluid">
                      <?php 
                      $sql = "SELECT * FROM `aboutuser` WHERE userID = '$useid'";  
                      $result = mysqli_query($conn, $sql); 
                      $row = mysqli_fetch_array($result);
                      ?>
                      <div class="row">
